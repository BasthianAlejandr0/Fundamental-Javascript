...
let entoroCercano = Math.round(numero * 100 * 0.5)//Round: Redondea hacia el enteor mas cercano
...
//Ejercio: Crea una funcion readNumber que pida un numero hasta que el visitante ingrese un valor numerico valido
